...
define('composer', [
	...
	composer.enhance = function (postContainer, post_uuid, postData) {
		...
		*/
		...
		submitBtn.on('click', function (e) {
			...
			if ($('.checkingAnonymous').is(':checked')) {
				console.log('The anonymous switch is checked');
			}
			else{
				console.log("nope");
			}
		...
		postContainer.find('.checkingAnonymous').on('click', function(e) {
			console.log("hello");
		})
	...
	async function post(post_uuid) {
		...
		var isAnonymousButton = postContainer.find('.checkingAnonymous');
		...
		var payload = {
			...
			isAnonymousButton: isAnonymousButton,
		};
		...
		if (action === 'topics.post') {
			...
			composerData = {
				...
				isAnonymous: isAnonymousButton.is(':checked'),
			};
